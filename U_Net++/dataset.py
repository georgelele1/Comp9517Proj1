...
class SegmentationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Extract NIR channel and concatenate with RGB to create 4 channels
        nir = nrg[..., 0:1]  # NIR is typically the first channel in NRG images
        four_band = np.concatenate([nir, rgb], axis=-1)
        four_band = four_band.transpose(2, 0, 1) / 255.0  # Normalize to [0, 1] and CHW format
